...
from config import TEST_DIR, RUNS_DIR, BATCH_SIZE, NUM_CLASSES
...
def test():
    ...
    if len(probe_dataset.mask_files) == len(probe_dataset.rgb_files) and len(probe_dataset.rgb_files) > 0:
        test_has_truth = True
