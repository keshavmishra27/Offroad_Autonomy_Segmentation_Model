"""
Segmentation Validation Script — Project 2 (DeepLabV3+)
Evaluates a trained DeepLabV3+ model on validation data and saves predictions.
"""
...
# ============================================================================
# Model: DeepLabV3+ (torchvision) — must match training
# ============================================================================
...
def build_deeplabv3plus(num_classes, pretrained=False):
    ...
    # Replace the auxiliary classifier to match training architecture
...
def main():
    ...
    # Build DeepLabV3+ model (no pretrained weights — we load our own)
    ...
    # strict=False: aux_classifier is only used during training; mismatches are safe to skip
