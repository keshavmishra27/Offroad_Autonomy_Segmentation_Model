"""
Segmentation Test / Inference Script — Project 6 (SegFormer MiT-B0)
Evaluates the trained SegFormer model on test/val data and saves predictions.

Usage:
  python test_segmentation6.py
  python test_segmentation6.py --model_path segformer_best.pth --data_dir <path>
  python test_segmentation6.py --num_samples 20  --batch_size 4

Outputs (in predictions6/):
...
# ============================================================================
# Shared class definitions (same as all other projects)
# ============================================================================
